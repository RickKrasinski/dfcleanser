...
function df_process_cmd_callback(optionId, fid) {
    ...
    */
    ...
    switch (optionId) {
        case 0: if (fid == 2) { opcode = RETURN; } break;
        case 1:
        case 2:
        case 3:
        case 4:
    ...
    switch (opcode) {
        case PROCESS:
            ...
            inputs.push(fparms);
            switch (optionId) {
                case 0: formid = "savecidrowtransform";     break;
                case 1: formid = "addcidrowtransform";      break;
                case 2: formid = "resetridcoltransform";    break;
                case 3: formid = "setnewcoltransform";      break;
                case 4: formid = "dtdroprowids";            break;
                case 5: formid = "dropdridcoltransform";    break;
            }
            if (formid != "") {
    ...
    */
    switch (fid) {
        ...
        case 15:
            ...
            break;
        case 9: window.run_code_in_cell(window.TRANSFORM_TASK_BAR_ID,window.getJSPCode(window.TRANSFORM_LIB,"display_data_transform","0")); break;
    }
...
function data_transform_add_cols_callback(optionId) {
    ...
    */
    ...
    switch (optionId) {
        ...
        case 1:
        case 2:
            formid = "addcolInput"; break;
        case 13:
            formid = "addcolfileInput"; break;
        case 14:
        case 15:
        case 16:
        case 17:
        case 21:
            formid = "addcolcodeInput"; break;
    }
    ...
    switch (optionId) {
        ...
        case 17: // add new column from code
            ...
            window.run_code_in_cell(window.TRANSFORM_TASK_BAR_ID,window.getJSPCode(window.TRANSFORM_LIB,"display_data_transform","11" + "," + JSON.stringify(inputs)));
            break;
        case 21:  window.run_code_in_cell(window.TRANSFORM_TASK_BAR_ID,window.getJSPCode(window.TRANSFORM_LIB,"display_data_transform","11" + "," + JSON.stringify(inputs))); break;
    }
    window.scroll_to('DCDataTransform');
}
...
function data_transform_cols_callback(funcid, optionId) {
    ...
    */
    ...
    if (element != null) {inputs.push(element.value);} 
    else {inputs.push("None");}
    inputs.push(funcid);
    ...
    switch (funcid) {
        case 0:
            var formid = "";
            switch (optionId) {
                case 1:     formid = "renamecolInput";          break;
                case 2:     formid = "addcolInput";             break;
                case 3:     formid = "dropcolInput";            break;
                case 4:     formid = "reordercolInput";         break;
                case 5:     formid = "maptransformInput";       break;
                case 6:     formid = "dummytransformInput";     break;
                case 7:     formid = "categorytransformInput";  break;
                case 11:    formid = "savecolInput";            break;
                case 12:    formid = "copycolInput";            break;
                case 14:    formid = "sortcolInput";            break;
                case 15:    formid = "applycolInput";           break;
            }
...
function dtctcol(colid, option) {
    ...
    *  option   - option
    */
    if (option == 30) {var fparms = ["3", colid, option];} 
    else {var fparms = [colid, option];}
    var inputs = new Array();
    inputs.push(fparms);
    // return to main
    if (option == 4) {
...
function dfrcol(colid) {
    ...
    var newList = "";
    if (currentList.val().length > 0) {newList = currentList.val() + ", " + "'" + colid + "'";} 
    else {newList = "'" + colid + "'";}
...
function dfsch_changedt(colid) {
     ...
     *  colid - column id
     */
    var nfval = $("#dfschinput" + colid).val();
    var rdval = getradioValues("rf" + colid);
    var ddval = getdropdownValues("dfschsel" + colid);
    ...
    console.log("dfsch_changedt", inputs);
