...
#from dfcleanser.common.debug_utils import is_debug_on

def is_debug_on(chapterid,flagvalue) :

    #print("is_debug_on",chapterid,flagvalue)
...
def inscb11() :
    set_chapter_debug_flag(DataInspection_ID,10)


DataInspectcbs          =   [Inspect_cb1,Inspect_cb2,Inspect_cb3,Inspect_cb4,Inspect_cb5,Inspect_cb6,Inspect_cb7,Inspect_cb8,Inspect_cb9,Inspect_cb10,Inspect_cb11]

DataInspecttext         =   ["DEBUG_DATA_INSPECT","DEBUG_DATA_INSPECT_DTYPES","DEBUG_DATA_INSPECT_ROWS","DEBUG_DATA_INSPECT_COLUMNS","DEBUG_INSPECT_DATATYPES",
                             "DEBUG_DATA_INSPECT_CATEGORIES","DEBUG_DATA_INSPECT_COLUMNS_DETAILS","DEBUG_INSPECT_ROWS_DETAILS","DEBUG_INSPECT_CATS","DEBUG_INSPECT_OUTLIERS",
                             "DEBUG_DISPLAY_TRACE"]

DataInspectflags         =   [False,False,False,False,False,False,False,False,False,False,False] 

DataInspectcallbacks     =   [inscb1,inscb2,inscb3,inscb4,inscb5,inscb6,inscb7,inscb8,inscb9,inscb10,inscb11]
...
DataCleansetext         =   ["DEBUG_CUNIQUES","DEBUG_CLEANSING","DEBUG_CLEANSING_DETAILS","DEBUG_CLEANSE_COLUMN","DEBUG_CLEANSE_COLUMN_DETAILS",
                             "DEBUG_CLEANSE_COLUMN_SINGLE","DEBUG_CLEANSE_ROWS","DEBUG_CLEANSE_ROWS_FILTER","DEBUG_CLEANSE_ROWS_FILTER_DETAILS","DEBUG_FILTERS_COLUMN_TABLE",
                             "DEBUG_FILTERS_STATS_TABLE","DEBUG_DATA_CLEANSING"]

DataCleanseflags         =   [False,False,False,False,False,False,False,False,False,False,False,False] 

DataCleansecallbacks     =   [clncb1,clncb2,clncb3,clncb4,clncb5,clncb6,clncb7,clncb8,clncb9,clncb10,clncb11,clncb12]
"""
...
Transform_cb6 = QCheckBox("trncb6")
...
DataTransformcbs          =   [Transform_cb1,Transform_cb2,Transform_cb3,Transform_cb4,Transform_cb5,Transform_cb6]

DataTransformtext         =   ["DEBUG_TRANSFORM","DEBUG_TRANSFORM_DATAFRAMES","DEBUG_TRANSFORM_DATETIME","DEBUG_TRABSFORM_COLUMN","DEBUG_TRANSFORM_COLUMN_DETAILS",
                               "DEBUG_TRANSFORM_DATAFRAME"]

DataTransformflags         =   [False,False,False,False,False,False]
...
Export_cb11 = QCheckBox("expcb11")
Export_cb12 = QCheckBox("expcb12")  
Export_cb13 = QCheckBox("expcb13")
Export_cb14 = QCheckBox("expcb14")
Export_cb15 = QCheckBox("expcb15")
Export_cb16 = QCheckBox("expcb16")
Export_cb17 = QCheckBox("expcb17")  
...
def expcb10() :
    set_chapter_debug_flag(DataExport_ID,10)
def expcb11() :
    set_chapter_debug_flag(DataExport_ID,11)
def expcb12() :
    set_chapter_debug_flag(DataExport_ID,12)
def expcb13() :
    set_chapter_debug_flag(DataExport_ID,13) 
def expcb14() : 
    set_chapter_debug_flag(DataExport_ID,14)
def expcb15() :
    set_chapter_debug_flag(DataExport_ID,15)
def expcb16() :
    set_chapter_debug_flag(DataExport_ID,16)
def expcb17() :
    set_chapter_debug_flag(DataExport_ID,17)
...
DataExportcbs           =   [Export_cb1,Export_cb2,Export_cb3,Export_cb4,Export_cb5,Export_cb6,Export_cb7,Export_cb8,Export_cb9,Export_cb10,
                             Export_cb11,Export_cb12,Export_cb13,Export_cb14,Export_cb15,Export_cb16,Export_cb17]

DataExporttext          =   ["DEBUG_DATA_EXPORT","DEBUG_DATA_EXPORT_HISTORIES","DEBUG_DATA_EXPORT_FILE_TYPE","DEBUG_DATA_EXPORT_FORMS","DEBUG_DATA_EXPORT_CONNECTORS",
                             "DEBUG_DATA_EXPORT_CSV","DEBUG_DATA_EXPORT_EXCEL","DEBUG_DATA_EXPORT_JSON","DEBUG_DATA_EXPORT_XML","DEBUG_DATA_EXPORT_HTML",
                             "DEBUG_DATA_EXPORT_SQLTABLE","DEBUG_DATA_EXPORT_CUSTOM","DEBUG_DATA_EXPORT_FILE_TYPES ","DEBUG_DATA_EXPORT_HISTORY","DEBUG_DATA_EXPORT_HISTORY",
                             "DEBUG_DATA_EXPORT_PARMS","DEBUG_DATA_IMPORT_FILE_TYPES"]

DataExportflags         =   [False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False] 

DataExportcallbacks     =   [expcb0,expcb1,expcb2,expcb3,expcb4,expcb5,expcb6,expcb7,expcb8,expcb9,expcb10,expcb11,expcb12,expcb13,expcb14,expcb15,expcb16,expcb17]
...
def geocb17() :
    set_chapter_debug_flag(SWGeocodeUtility_ID,17)
...
Geocodecbs              =   [Geocode_cb1,Geocode_cb2,Geocode_cb3,Geocode_cb4,Geocode_cb5,Geocode_cb6,Geocode_cb7,Geocode_cb8,Geocode_cb9,Geocode_cb10,
                             Geocode_cb11,Geocode_cb12,Geocode_cb13,Geocode_cb14,Geocode_cb15,Geocode_cb16,Geocode_cb17]

Geocodetext             =   ["DEBUG_DATA_EXPORT","DEBUG_DATA_EXPORT_HISTORIES","DEBUG_DATA_EXPORT_FILE_TYPE","DEBUG_DATA_EXPORT_FORMS","DEBUG_DATA_EXPORT_CONNECTORS",
                             "DEBUG_DATA_EXPORT_CSV","DEBUG_DATA_EXPORT_EXCEL","DEBUG_DATA_EXPORT_JSON","DEBUG_DATA_EXPORT_XML","DEBUG_DATA_EXPORT_HTML",
                             "DEBUG_DATA_EXPORT_SQLTABLE","DEBUG_DATA_EXPORT_CUSTOM","DEBUG_DATA_EXPORT_FILE_TYPES ","DEBUG_DATA_EXPORT_HISTORY","DEBUG_DATA_EXPORT_HISTORY",
                             "DEBUG_DATA_EXPORT_PARMS","DEBUG_DATA_IMPORT_FILE_TYPES"]

Geocodeflags            =   [False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False] 

Geocodecallbacks        =   [geocb0,geocb1,geocb2,geocb3,geocb4,geocb5,geocb6,geocb7,geocb8,geocb9,geocb10,geocb11,geocb12,geocb13,geocb14,geocb15,geocb16,geocb17]
"""
...
class DataframeCleanserChapterDebugValues :
    ...
    def set_debug_value(self, chaptertext, debugvalue) :
